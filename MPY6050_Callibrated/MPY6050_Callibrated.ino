...
// Declaring variables for callibration
float Rate_Callibration_Roll, Rate_Callibration_Pitch, Rate_Callibration_Yaw;
int Rate_Callibration_Number;
...
void setup() {
  ...
  for(Rate_Callibration_Number = 0 ; Rate_Callibration_Number < 2000 ; Rate_Callibration_Number ++)
  {
    gyro_signals();
    Rate_Callibration_Roll += RateRoll;
    Rate_Callibration_Pitch += RatePitch;
    Rate_Callibration_Yaw += RateYaw;
    delay(1);
  }
  Rate_Callibration_Roll /= 2000;
  Rate_Callibration_Pitch /= 2000;
  Rate_Callibration_Yaw /= 2000;
}

void loop() {
  // Call the predefined function to read the gyro measurements
  gyro_signals();
  RateRoll -= Rate_Callibration_Roll;
  RatePitch -= Rate_Callibration_Pitch;
  RateYaw -= Rate_Callibration_Yaw;
